"""
Answer-generation module for the Multi-Query RAG pipeline.

Formats a RAG prompt from the RRF-fused context documents and calls the
Groq LLaMA 3.3 70B model to produce a grounded answer.
"""
from multiquery_rag.implementation.config import GROQ_API_KEYS, GROQ_MODEL
...
def generate(query: str, context_docs: list, temperature: float = 0.1) -> str:
    """Build a RAG prompt from RRF-fused docs and call the LLM."""
    context_block = "\n\n".join(
