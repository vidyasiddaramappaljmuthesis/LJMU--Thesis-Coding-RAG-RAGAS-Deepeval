"""
ChromaDB ingestion for the Multi-Query RAG pipeline.
...
Multi-Query RAG shares the same ChromaDB collection ("ecommerce_kb") as
the other RAG pipelines.  If the index is already built, this module
reuses it without re-embedding.
"""
import json
import logging
