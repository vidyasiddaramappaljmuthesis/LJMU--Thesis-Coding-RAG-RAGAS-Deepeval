"""
ChromaDB ingestion for the Reranking RAG pipeline.
...
The Reranking RAG shares the same ChromaDB collection as the Naive RAG
(both use COLLECTION_NAME = "ecommerce_kb").  If the index is already built
by another pipeline, this module reuses it without re-embedding.
"""
import json
import logging
